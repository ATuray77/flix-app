...
//Fetch data from TMDB API. Function displaying popular shows
...
//Display TV show details -  starts
async function displayShowDetails(){
    const ShowId = window.location.search.split('=')[1]; //isolate the id using 'split' method
    
    const show = await fetchAPIData(`tv/${ShowId}`); //fetch the data(movie id)
    console.log(show)
    //overlay for background image
...
function displayPagination() {
    ...
    //Next page - adding event listener to the 'next' button
...
//Make requests to search - starts
